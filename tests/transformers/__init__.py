...
class TestTransformer(unittest.TestCase):
    ...
    def test_basic(self):
        ...
        for _test_name in _tests_tree.keys():
            ...
            if not _skip == 'y':
                ...
                print(f'skipping basic-tests:{_test_name}')
    ...
    def test_if_keys(self):
        ...
        for _test_name in _tests_tree.keys():
            ...
            if not _skip == 'y':
                _input_tree = _test_tree.get('input/').copy()
                # we are changing tree structure here with the transform, so we cannot just overlay
                _output_tree = _test_tree.get('output/').copy()
                ...
                print(f'skipping if-keys:{_test_name}')
    ...
    def test_if_vars(self):
        ...
        for _test_name in _tests_tree.keys():
            ...
            if not _skip == 'y':
                ...
                print(f'skipping if-vars:{_test_name}')
    ...
    def test_context(self):
        ...
        for _test_name in _tests_tree.keys():
            ...
            if not _skip == 'y':
                ...
                print(f"Skipping context:{-_test_name}")
    ...
    def test_import(self):
        ...
        for _test_name in _tests_tree.keys():
            ...
            if not _skip == 'y':
                ...
                print(f"Skipping imports:{_test_name}")
            self._is_confluent(_test_tree.get('input/').copy(), _output_tree)
    ...
    def test_plaintext(self):
        ...
        for _test_name in _tests_tree.keys():
            ...
            if not _skip == 'y':
                ...
                print(f'skipping plaintext:{_test_name}')
    ...
    def test_at_if_vars(self):
        ...
        for _test_name in _tests_tree.keys():
            ...
            if not _skip == 'y':
                ...
                print(f'skipping if-at-vars:{_test_name}')
